 ...
 *
 * @author Simon Larsén and Sabrina Chowdhury
 * @version 2017-12-12
 */
public class LinkedListTest {
    ...
    public void getLastIsLastElementWhenListIsNonEmpty() {
        // Arrange
        int evenExpectedLastElem = evenLengthArray[evenLengthArray.length - 1];
        int oddExpectedLastElem = oddLengthArray[oddLengthArray.length - 1];
        ...
        // Assert
        assertThat(evenLastElem, equalTo(evenExpectedLastElem));
        assertThat(oddLastElem, equalTo(oddExpectedLastElem));
    }
    ...
    public void sizeIs0WhenListIsEmpty() {
        ...
        //Arrange
        int emptyListExpectedSize = 0;

        //Act
        int emptyListSize = emptyList.size();

        //Assert
        assertThat(emptyListSize,equalTo(emptyListExpectedSize));
    ...
    public void sizeIs1WhenAllButOneElementHasBeenRemoved() {
        ...
        // Assert
        assertThat(evenLengthNewSize, equalTo(1));
        assertThat(oddLengthNewSize, equalTo(1));
    ...
    public void addLastFiveTimesIncreasesSizeByFive() {
        ...
        for (int i = 0; i < increase; i++) {
            emptyList.addLast(i);
            evenLengthList.addLast(i);
            oddLengthList.addLast(i);
        }
        int emptyListActualSize = emptyList.size();
        int evenLengthListActualSize = evenLengthList.size();
        int oddLengthListActualSize = oddLengthList.size();
    ...
    public void isEmptyIsTrueWhenAllElementsHaveBeenRemoved() {
        ...
        removeElements(evenLengthList, removeAmountFromEven);
        removeElements(oddLengthList, removeAmountFromOdd);
        boolean emptyEven = evenLengthList.isEmpty();
        boolean emptyOdd = oddLengthList.isEmpty();

        // Assert
        assertTrue(emptyEven);
        assertTrue(emptyOdd);
    }
